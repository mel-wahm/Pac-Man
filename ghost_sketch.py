...
class	Sketch(arcade.Window):
	...
	def on_draw(self):
		...
		arcade.draw_arc_filled(cx - 100, cy + 100, 350, 350, (0, 0, 64),
						 0, 180)
		...
		arcade.draw_arc_filled(cx - 150, cy + 140, 65, 90, arcade.color.WHITE,
						 0, 360)
		arcade.draw_arc_filled(cx - 150 + 5 * eye_x, cy + 140 - 5 * eye_y, 45, 60, (0, 0, 64),
								 0, 360)
		arcade.draw_arc_filled(cx - 60, cy + 140, 65, 90, arcade.color.WHITE,
								 0, 360)
		arcade.draw_arc_filled(cx - 60 + 5 * eye_x, cy + 140 - 5 * eye_y, 45, 60, (0, 0, 64),
										 0, 360)
		...
		for i in range(20):
			xs = mlx + i * 12
			y = cy + 30 + 5 * math.sin(i + self.anim_time * 5)
			mouth.append((xs, y))
