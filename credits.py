...
class	Credits(arcade.View):
	def __init__(self, prev_view):
		...
		self.credits = arcade.Text("Credits: ", self.width / 2, self.height / 2 + 80,
							 arcade.color.WHITE, 42, anchor_x="center", font_name="Renogare")
		self.mel_wahm = arcade.Text("Mel-wahm", self.width / 2 - 160, self.height / 2,
							 arcade.color.WHITE, 42, anchor_x="center", font_name="Renogare")
		self.tsellak = arcade.Text("Tsellak", self.width / 2 + 160, self.height / 2,
							 arcade.color.WHITE, 42, anchor_x="center", font_name="Renogare")
